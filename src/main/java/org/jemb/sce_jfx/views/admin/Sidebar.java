...
public class Sidebar extends VBox {
    ...
    private void createMenu() {
        ...
        VBox menuButtons = new VBox(5, btnDashboard, btnEstudiantes, btnMaterias,
                btnInscripciones, btnCalificaciones, btnReportes, btnConfiguracion, btnProfile);
    ...
    private SVGPath createScaledSvgIcon(String path, double desiredSize) {
        ...
        // Calcular la relación de aspecto original como en el ejemplo
    ...
    private void setActiveButton(Button activeButton) {
        Arrays.asList(btnDashboard, btnEstudiantes, btnMaterias, btnInscripciones,
                        btnCalificaciones, btnReportes, btnConfiguracion, btnProfile)
